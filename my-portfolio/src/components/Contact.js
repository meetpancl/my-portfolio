...
function Contact() {
    ...
    const contactInfo = [{
            icon: '📧',
            title: 'Email',
            value: 'panchalmeet088@gmail.com',
            link: 'mailto:panchalmeet088@gmail.com'
        },
        {
            icon: '💼',
            title: 'LinkedIn',
            value: 'Connect with me',
            link: 'https://www.linkedin.com/in/meet-panchal-64ba20229/'
        },
        {
            icon: '🐙',
            title: 'GitHub',
            value: 'View my code',
            link: 'https://github.com/meetpancl'
        },
        {
            icon: '📱',
            title: 'Phone',
            value: '+91 9116475626',
            link: 'tel:+919116475626'
        }
    ];
